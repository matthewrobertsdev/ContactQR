...
class StoredContacts{
    ...
    private init(){
        do{
            contacts=try QR_Persistency.shared.getSavedContacts()
    ...
    func tryToSave(){
            do{
                ...
                try QR_Persistency.shared.saveContacts(contactsToSave: contacts)
    ...
    func testEncodeAndDecode(){
        do{
            try QR_Persistency.shared.testEncodeAndDecode(contactsToSave: contacts)
        }
        catch{
