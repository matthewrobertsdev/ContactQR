...
class MessagesViewController: MSMessagesAppViewController, UITableViewDataSource,
	...
	var persistentContainer: NSPersistentCloudKitContainer = loadPersistentCloudKitContainer()
	override func viewDidLoad() {
        super.viewDidLoad()
		print("abcd viewDidLoad")
		...
		DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
			...
			strongSelf.persistentContainer = loadPersistentCloudKitContainer()
...
func loadPersistentContainer() -> NSPersistentContainer {
	let container=NSPersistentContainer(name: "ContactCards")
